...
const Search = () => {
  ...
  return (
    <div className="shrink-0">
      ...
      {err && (
        <>
          <div className="w-full mt-5 text-sm text-center">User not found!</div>
      ...
      {user && (
        <>
          <div
            className="flex items-center gap-4 px-4 py-2 mt-5 cursor-pointer rounded-xl hover:bg-c5"
